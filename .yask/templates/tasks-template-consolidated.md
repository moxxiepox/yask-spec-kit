---
date: '2025-12-28'
description: Consolidated tasks template for YASK system
status: active
tags:
  - yask
  - yask/type/template
  - yask/status/active
title: Tasks Template - Consolidated
version: 6.0.0
---
...
{% block document_type %}Tasks{% endblock %}
{% block validation_requirements %}Hierarchical Structure, Traceability, Implementation Flow{% endblock %}
{% block quality_gates %}Tasks Quality Gate{% endblock %}
