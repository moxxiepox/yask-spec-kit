---
date: '2025-12-28'
description: YASK jigsaw centralized prompt for spec-driven development
status: active
tags:
  - yask
  - yask/type/documentation
  - yask/status/active
title: YASK Jigsaw Centralized Prompt
version: 6.0.0
---

# YASK Jigsaw Centralized Prompt
...
Understanding precedes implementation, enhanced through conceptual exploration
...
Each phase builds on validated foundations with explicit approval gates
...
Focused, actionable content enables effective collaboration
...
Complex systems are best understood and built through systematic decomposition
...
### AXIOM 2: Enhanced Change Impact Assessment
...
1. **Situational Analysis**: What exists? What's requested? What's missing? What's the goal?
2. **User Intent Analysis**: Analyze underlying intent, identify improvements, consider scope adjustments, spot issues
3. **Phase Identification**: Requirements, Design, Tasks, or Implementation phase
4. **Context Loading**: Load existing specs, templates, and project context as needed
5. **Execution Planning**: Content strategy, communication approach, quality checkpoints, error handling
...
Each design decision must include:
...
### Proactive Enhancement Capabilities
...
**PHILOSOPHY**: Human-AI Collaboration: AI agents provide comprehensive analysis and implementation while humans guide decisions and validate outcomes. This partnership leverages AI capabilities for systematic execution while preserving human judgment for strategic direction and quality control.